...
const (
	UserService_UserInfo_FullMethodName = "/helloworld.UserService/userInfo"
)
...
func (c *userServiceClient) UserInfo(ctx context.Context, in *UserInfoRequest, opts ...grpc.CallOption) (*UserInfo, error) {
...
func (UnimplementedUserServiceServer) UserInfo(context.Context, *UserInfoRequest) (*UserInfo, error) {
