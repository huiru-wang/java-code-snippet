package com.xiaohan.demo.spring.mvc.aop;

import com.xiaohan.demo.spring.mvc.model.HttpAccessLog;
...
public class HttpAccessLogAspect {
     ...
     * .*(..)：任意方法、任意参数
     */
    @Pointcut("execution(public * com.xiaohan.demo.spring.mvc.controller.*.*(..))")
